<nav class="col-md-2 d-none d-md-block bg-light sidebar">
  <div class="sidebar-sticky">
    <ul class="nav flex-column">
      ...
      <li class="nav-item">
        <a class="nav-link <?php echo ($page == '' || $page == 'Administrateur.php') ? 'active' : ''; ?>" href="Administrateur.php">
      ...
      <li class="nav-item">
        <a class="nav-link <?php echo ($page == 'allfournisseurs.php') ? 'active' : ''; ?>" href="allfournisseurs.php">
...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2 ">Hello, <?php echo $_SESSION['name']; ?></h1>
